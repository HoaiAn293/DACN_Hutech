...
const VehicleSelector = ({ onSelect }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto bg-white rounded-2xl p-6 relative">
      <h1 className="font-semibold text-[24px] text-[#4e7cb2] mb-8">
        Chọn xe phù hợp
      </h1>
        ...
        {vehicles.map((vehicle, index) => (
          <SwiperSlide key={index}>
            ...
            >
              ...
              <div className="text-[#4e7cb2] font-bold text-lg mb-2">
                {vehicle.label}
              </div>
