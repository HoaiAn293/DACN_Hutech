  ...
  <div className="chatbot-wrapper">
    ...
    {isOpen && (
      <div className="chatbot-container">
        ...
        {/* Suggestions ở ngay trên ô nhập */}
        {messages.length === 0 && (
          <div className="chatbot-suggestions">
            {["Đặt xe", "Kiểm tra đơn hàng", "Liên hệ hỗ trợ"].map((suggestion, index) => (
              <button
                key={index}
                ...
                onClick={() => {
                  ...
                  setTimeout(() => {
                    document.querySelector('.chatbot-input-form').dispatchEvent(new Event('submit', { cancelable: true, bubbles: true }));
                  }, 100);
                }}
              >
                {suggestion}
